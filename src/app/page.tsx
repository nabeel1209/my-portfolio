...
export default function Home() {
  ...
  return (
    <main className='relative w-full flex flex-col justify-center items-center'>
      ...
      <div className="hidden lg:block fixed w-12 h-12 rounded-full z-50 bottom-0 left-0 border-solid border-2 pointer-events-none -translate-y-1/2 -translate-x-1/2 mix-blend-difference" ref={cursor}></div> 
