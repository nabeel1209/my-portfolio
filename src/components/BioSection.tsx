    ...
    return(
        <section className='relative w-full p-8 flex flex-col items-center gap-5 mt-16 scroll-mt-16 sm:w-[40rem] lg:w-[90%] lg:flex-row lg:justify-between lg:mt-8 lg:scroll-mt-16 lg:pt-12 xl:mt-16 xl:scroll-mt-20' ref={ref as any}>
          ...
          <div className='w-full flex flex-col text-white px-4 items-center gap-1 lg:w-[28rem] xl:w-[33.8125rem] lg:h-full lg:items-start'>
            ...
            <p className='font-inter font-normal text-base text-center lg:text-start'>I craft user-focused solutions by combining adaptable programming skills with thoughtful design. With a strong drive for continuous learning and effective teamwork, I contribute to diverse digital projects — from <span className="bg-gradient-to-r from-rose-500 to-amber-400 bg-clip-text text-transparent font-semibold">web development</span> to <span className="bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent font-semibold">data science.</span></p>
          </div>
