    ...
    return(
        <section className='relative w-full p-8 flex flex-col items-center gap-5 mt-16 scroll-mt-16 sm:w-[40rem] lg:w-[90%] lg:flex-row lg:justify-between lg:mt-8 lg:scroll-mt-16 lg:pt-12 xl:mt-16 xl:scroll-mt-20' ref={ref as any}>
          ...
          <div className='w-full flex flex-col text-white px-4 items-center gap-1 lg:w-[28rem] xl:w-[33.8125rem] lg:h-full lg:items-start'>
            ...
            <p className='font-inter font-normal text-base text-center lg:text-start'>With expertise in <span className="font-black bg-[linear-gradient(to_right,#406d99_20%,#fad55b_80%)] bg-clip-text text-transparent"><a href="https://www.python.org/" target="_blank">Python</a></span> and <span className="font-black bg-[linear-gradient(to_right,#ec2025_20%,#a01618_80%)] bg-clip-text text-transparent"><a href="https://www.java.com/">Java</a></span> for data science, I specialize in leveraging data to solve complex problems and generate actionable insights. I am passionate about continuous learning, meticulous in documentation, and experienced in leading collaborative teams.</p>
          </div>
